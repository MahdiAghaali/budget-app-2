...
- [Budget App](https://budget-app-2-production.up.railway.app)
...
```
  git clone https://github.com/MahdiAghaali/budget-app-2
  cd Budget-App-2
  bundle install
  rails db:create
  rails db:migrate
...
Feel free to check the [issues page](https://github.com/MahdiAghaali/budget-app-2/issues).
